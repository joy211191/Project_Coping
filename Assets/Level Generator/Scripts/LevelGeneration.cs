...
public class LevelGeneration : MonoBehaviour
{
    ...
    private void Awake () {
        ...
        playerSpawnPoint.position = startingPositions[randStartingPos].position;
        Instantiate(rooms[1], transform.position, Quaternion.identity);

        direction = Random.Range(1, 6);
        //for(; ;stopGeneration=false) {
        //    Move();
        //}
    }
    ...
    public void SpawnPlayer () {
        ...
        GameObject go = Instantiate(playerPrefab, playerSpawnPoint.position, Quaternion.identity);
